...
-- local entity = {
--     type = "electric-pole",
--     name = protoNames.rangeExtender,
--     icon = "__base__/graphics/icons/substation.png",
--     icon_size = 64,
--     icon_mipmaps = 4,
--     flags = {"placeable-neutral", "player-creation"},
--     minable = {mining_time = 0.1, result = protoNames.rangeExtender},
--     max_health = 200,
...
local item = {
    ...
    place_result = protoNames.rangeExtender,
    stack_size = 50
}
...
local recipe = {
    ...
    result = protoNames.rangeExtender
}
